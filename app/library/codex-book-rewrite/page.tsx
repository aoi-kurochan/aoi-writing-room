      ...
      <article className="article-shell rewrite-article-shell">
        ...
        <header className="article-header">
          ...
          <div className="article-summary">
            <p>私は最近、Codexを使って既刊を5冊リライトしました。</p>
            <p>
              本文だけではなく、現在仕様、表現の安全性、挿絵、巻末導線、最終DOCXまで。
        ...
        <section id="phase-1">
          ...
          <RoleSplit
            codex={<ul><li>旧版を読み、古くなった可能性を探す</li><li>現在の説明とのずれを候補にする</li><li>改善できる範囲を整理する</li></ul>}
            human={<ul><li>この本を対象にするか</li><li>テーマを本棚に残すか</li><li>新刊より、この本へ時間を使うか</li></ul>}
          />
        </section>
        ...
        <section id="phase-3">
          ...
          <p>
            すると、途中までで使える文脈量がほぼなくなり、身動きが取りにくくなりました。
          ...
          <ol className="timeline">
            ...
            <li><span>07</span><div><b>最終DOCXを検査する</b><p>目次、画像、リンク、全ページ、安全性を確認する。</p></div></li>
          </ol>
          <p>
        ...
        <section id="phase-5">
          ...
          <p><a className="text-link" href="https://aoi-kurochan.github.io/aoi-books/" target="_blank" rel="noreferrer">あおいの本棚を見る →</a></p>
        ...
        <footer className="article-end">
          ...
          <p>
            ...
            利用前に<a href="https://developers.openai.com/" target="_blank" rel="noreferrer">OpenAI公式ページ</a>で現在の情報をご確認ください。
          </p>
        </footer>
      </article>
      <SiteFooter />
