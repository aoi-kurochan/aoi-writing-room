  ...
  return <main>
    ...
    <article className="article-shell rewrite-article-shell">
      ...
      <section id="flow-1">
        ...
        <p>既刊が何冊もある場合、古い本を全部リライトしようとすると、作業量の多さに圧倒され、なかなか着手できません。大事なのは出版から何年経ったかではありません。その本へもう一度時間を使うことで、読者へ渡せる価値が上がるかどうかです。</p>
...
まだ本文は変更しないでください。`}</PromptBlock>
      ...
      <section id="flow-2">
        ...
        <p>リライトで怖いのは、古い部分を直すうちに、その本の良かったところまで消してしまうことです。この本が長く読まれた理由は、ChatGPTやnoteの操作説明だけではありません。AIに文章を任せきるのではなく、ChatGPTを使いながらも、自分の経験や言葉をnoteに残す。その考え方こそ、この本で一番伝えたかったことでした。</p>
...
まだ残りの画像は作らないでください。`}</PromptBlock>
      ...
      <section id="flow-5">
        ...
        <p>今回は、Codexを活用して、次の順番で巻末を作ることができました。</p>
...
実際のKindle環境での動作を確認できない場合は、「未確認」と報告してください。`}</PromptBlock>
        ...
        <p>本棚サイトは、今回のリライトとは別のタイミングで作ったものです。ただ、リライトした本の巻末から本棚へ進める案内を、この機会にきちんと入れました。これは今回の追加記事の主役ではないため、作り方は最小限に留めます。</p>
...
まだ公開や提出はしないでください。`}</PromptBlock>
      ...
      <section id="conclusion" className="rewrite-conclusion">
        ...
        <p>最初から、挿絵や巻末の関連書籍まで、すべて整える必要はありません。まずは、今も残す価値のある既刊を1冊選ぶ。次に、絶対に変えないものと、直したいものを書く。そして、本文を変更せず、修正候補だけを出してもらう。ここまでできれば、リライトを始める準備は十分です。</p>
