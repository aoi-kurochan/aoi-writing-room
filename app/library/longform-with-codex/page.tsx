    ...
    <main>
      ...
      <article className="article-shell">
        ...
        <section id="voice">
          ...
          <p>
            このページでは、音声で自分の経験や考えをAIへまとめて渡すことを
            「音声ダンプ」と呼びます。
          </p>
          <p>
        ...
        <section id="questions">
          ...
          <p>
            ...
            この本を作ったときは、AIから出された約20問に、音声で順番に答えました。
            質問が多すぎる場合は、「重要なものから5問ずつ出してください」と頼んで構いません。
          </p>
          <p>
        ...
        <section id="case-study">
          ...
          <p>
            ここからは、実際に使った音声回答、AIが整理した改稿案、
            最終的に本へ掲載した完成稿を順番に見ていきます。
          </p>
        ...
        <section id="parallel-review">
          ...
          <p>
            ...
            そこで、同じ原稿と同じ基準を複数のAIへ渡し、別の角度から読んでもらいます。
            すべての意見が揃うまで、本文は修正しません。集まった意見はCodexへ渡し、
            「絶対修正」「どちらかと言えば修正」「今回は受け入れなくてよい」の3段階へ
            整理し直した案を作ってもらいます。
            その案を採用するか、見送るかは、最後に私が決めます。
          </p>
          ...
          <div className="review-comparison">
            ...
            <article>
              ...
              <p>
                別のAIから、星による評価と文章つきレビューが混ざり、
                初心者が件数を誤解する可能性があるという指摘を受けました。
